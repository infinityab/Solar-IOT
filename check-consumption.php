...
<?php
  ...
  if ($j > 0) {
     $pc = ($poweravailable * 1000)- $j;
  } else {
     $pc = ($poweravailable * 1000) + (0 - $j);
  ...
  curl_setopt($ch,CURLOPT_HTTPHEADER, array(
    "X-Pvoutput-Apikey: Your API Key   ", "X-Pvoutput-SystemId: Your System ID "));
  ...
  // $result = exec('curl "http://pvoutput.org/service/r2/addstatus.jsp" -H "X-Pvoutput-Apikey: Your API Key" -H "X-Pvoutput-SystemId: Your System ID " -d "d=20160324" -d "t=07:45" -d "v4=110" -0');
