...
$schedules = array(
  "Schedule-1" => array(
    "Hot Water Main" => array(6,1,1,12,30,2,30),
    "Pool Pump" => array(5,0,1,2,0,2,0),
    "Enviro Pump" => array(10,0,1,8,50,9,0),
    "Wireless Pwr1" => array(11,0,1,8,30,12,0),
    "Wireless Pwr2" => array(3,0,1,8,30,0,1),
    "Aircon WiFi-1" => array(4,0,1,9,45,9,0),
    "Aircon WiFi-2" => array(0,0,1,9,45,14,0),
    ),
  "Schedule-2" => array(
    "Hot Water Main" => array(6,0,1,11,30,2,30),
    "Pool Pump" => array(5,0,1,11,30,1,30),
  ...
  "Schedule-3" => array(
    "Hot Water Main" => array(6,0,1,2,0,1,30),
  ...
  "Schedule-4" => array(
    "Hot Water Main" => array(6,0,1,11,0,6,0),
