...
<br><b>Auto</b> - used for Auto Power Management (APM), 0=OFF any other number=ON, power calculated in order of number, 1 = first, 2 next and so on. The APM function works within any existing schedule so prudent to set aside a wider ranging schedule or one that may be optionally suspended for this purpose.
<br><b>Auto On Time</b> - this is set in the Config file and is used to determine the hours that AUTO may be applied which will be the current daylight sun hours. Outside of these hours AUTO is ignored.
