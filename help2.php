...
It is designed to serve Wifi Clientside relay units, 433Mhz Wireless sockets and to drive Contacters for permanently wired or high power appliances directly from the switchboard. All three of these modes are optional. Optical iscolation is used for all switching.
<p>
<p class="ex2">For high power devices or high inductance loads use contacters which may be switched on or off by optically iscolated relays. The relay boards are cheap and come in various sizes 1, 2,4,8 and 16 relay versions.
